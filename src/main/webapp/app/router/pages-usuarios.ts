  ...
  children: [
    {
      ...
      name: 'inicio_usuario',
      component: Inicio,
      meta: { authorities: [Authority.USER, Authority.ADMIN, Authority.DECANO, Authority.JEFE_PROGRAMA, Authority.PROFESOR] },
    },
    {
      path: 'programas-lista',
      name: 'usuario_programas_lista',
      component: ProgramasLista,
      meta: { authorities: [Authority.ADMIN, Authority.DECANO, Authority.JEFE_PROGRAMA, Authority.PROFESOR] },
    },
    {

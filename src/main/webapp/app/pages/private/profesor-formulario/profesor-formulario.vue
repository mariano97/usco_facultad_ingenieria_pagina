  ...
  <div class="container_formulario_profesor">
          ...
          <div class="">
            <div class="row mx-0">
              <div class="col-3 form-group px-0">
                <label
                  ...
                  for="firstName"
                  v-text="$t('profesor.formulario.labels.primerNombre')"
                ></label>
                <input
                  type="text"
                  id="firstName"
                ...
                <div class="" v-if="$v.userAccount.firstName.$anyDirty && $v.userAccount.firstName.$invalid">
                  <small class="form-text text-danger" v-if="!$v.userAccount.firstName.required" v-text="$t('entity.validation.required')">
                  ...
                  <small
                    class="form-text text-danger"
                    v-if="!$v.userAccount.firstName.minLength"
              ...
              <div class="col-3 form-group">
                <label class="form-control-label" for="secondName" v-text="$t('profesor.formulario.labels.segundoNombre')"></label>
                <input
                  type="text"
                  id="secondName"
                  name="secondName"
                  class="form-control"
                  placeholder="Eg. Andrés"
                  v-model="$v.userAccount.secondName.$model"
                  :disabled="checkHabilitacionCampos()"
                />
                <div class="" v-if="$v.userAccount.secondName.$anyDirty && $v.userAccount.secondName.$invalid">
                  <small
                    class="form-text text-danger"
                    v-if="!$v.userAccount.secondName.maxLength"
                    v-text="$t('entity.validation.maxlength', { max: 50 })"
                  >
                    This field cannot be longer than 50 characters.
                  </small>
              ...
              <div class="col form-group px-0">
                <label class="form-control-label campo_requerido" for="lastName" v-text="$t('profesor.formulario.labels.lastName')"></label>
                <input
                  type="text"
                  id="lastName"
                  name="lastName"
                ...
                <div class="" v-if="$v.userAccount.lastName.$anyDirty && $v.userAccount.lastName.$invalid">
                  <small class="form-text text-danger" v-if="!$v.userAccount.lastName.required" v-text="$t('entity.validation.required')">
                    Este campo es obligatorio.
                  </small>
                  <small
                    class="form-text text-danger"
                  ...
                  <small
                    class="form-text text-danger"
                    v-if="!$v.userAccount.lastName.minLength"
                    v-text="$t('entity.validation.minlength', { min: 5 })"
                  >
                    This field cannot be longer than 50 characters.
                  </small>
            ...
            <div class="row mx-0">
              <div class="col-5 form-group px-0">
                <label class="form-control-label campo_requerido" for="email" v-text="$t('profesor.formulario.labels.email')"></label>
                <input
                  type="text"
                  id="email"
                  name="email"
                ...
                <div class="" v-if="$v.userAccount.email.$anyDirty && $v.userAccount.email.$invalid">
                  <small class="form-text text-danger" v-if="!$v.userAccount.email.required" v-text="$t('entity.validation.required')">
                    Este campo es obligatorio.
                  </small>
                  <small
                    class="form-text text-danger"
                  ...
                  <small class="form-text text-danger" v-if="!$v.userAccount.email.email" v-text="$t('entity.validation.email')">
                    This field cannot be longer than 50 characters.
                  </small>
                </div>
              </div>
              <div class="col-5 form-group">
                <label class="form-control-label" for="emailAlternativo" v-text="$t('profesor.formulario.labels.emailAlternativo')"></label>
                <input
                  type="text"
                  id="emailAlternativo"
                ...
                <div class="" v-if="$v.profesor.emailAlternativo.$anyDirty && $v.profesor.emailAlternativo.$invalid">
                  <small
                    class="form-text text-danger"
                    v-if="!$v.profesor.emailAlternativo.maxLength"
                    v-text="$t('entity.validation.maxlength', { max: 50 })"
                  >
                    This field cannot be longer than 50 characters.
                  </small>
                  <small class="form-text text-danger" v-if="!$v.profesor.emailAlternativo.email" v-text="$t('entity.validation.email')">
                    This field cannot be longer than 50 characters.
                  </small>
                </div>
              </div>
              <div class="col form-group px-0">
                <label class="form-control-label" for="telefonoCelular" v-text="$t('profesor.formulario.labels.telCelular')"></label>
                <input
                  type="text"
                  id="telefonoCelular"
                  name="telefonoCelular"
                  class="form-control"
                  placeholder="Eg. 31234567890"
                ...
                <div class="" v-if="$v.profesor.telefonoCelular.$anyDirty && $v.profesor.telefonoCelular.$invalid">
                  <small
                    class="form-text text-danger"
                    v-if="!$v.profesor.telefonoCelular.maxLength"
                    v-text="$t('entity.validation.maxlength', { max: 50 })"
                  >
                    This field cannot be longer than 50 characters.
                  </small>
            ...
            <div class="row mx-0">
              <div class="col form-group">
                <label class="form-control-label" for="oficina" v-text="$t('profesor.formulario.labels.oficina')"></label>
                <input
                  type="text"
                  id="oficina"
                  name="oficina"
                  class="form-control"
                  placeholder="Eg. Piso 3 bloque B"
                ...
                <div class="" v-if="$v.profesor.oficina.$anyDirty && $v.profesor.oficina.$invalid">
                  <small
                    class="form-text text-danger"
                    v-if="!$v.profesor.oficina.maxLength"
              ...
              <div class="col form-group">
                <label
                  class="form-control-label campo_requerido"
                  for="tablaElementoCatalogo"
                  v-text="$t('profesor.formulario.labels.tipoProfesor')"
                ></label>
                <select
                  class="form-control"
                  id="tablaElementoCatalogo"
                ...
                <div class="" v-if="$v.profesor.tablaElementoCatalogo.$anyDirty && $v.profesor.tablaElementoCatalogo.$invalid">
                  <small
                    class="form-text text-danger"
            ...
            <div class="row mx-0">
              <div class="col form-group px-0">
                <label class="form-control-label campo_requerido" for="perfil" v-text="$t('profesor.formulario.labels.perfil')"></label>
                <div class="d-flex justify-content-end">
                  <small class="count_tamano_text" :class="{ count_text_limit: countCharacter(255, $v.profesor.perfil.$model) < 10 }"
                    >Quedan {{ countCharacter(255, $v.profesor.perfil.$model) }} caracteres</small
                  >
                </div>
                <textarea
                  id="perfil"
                ...
                <div class="" v-if="$v.profesor.perfil.$anyDirty && $v.profesor.perfil.$invalid">
                  ...
                  <small
                    class="form-text text-danger"
                    v-if="!$v.profesor.perfil.maxLength"
                    v-text="$t('entity.validation.maxlength', { max: 255 })"
                  >
                    This field cannot be longer than 50 characters.
                  </small>
                  <small
                    class="form-text text-danger"
                    v-if="!$v.profesor.perfil.minLength"
                    v-text="$t('entity.validation.minlength', { min: 10 })"
                  >
                    This field cannot be longer than 50 characters.
                  </small>
    ...
    <section class="seccion_estudios_profesor" v-if="userAccount.id && profesor.id">
      <div class="tab">
        ...
        <label class="tab-label item_acordion" for="estudios_profesor" v-text="$t('profesor.formulario.labels.estudiosProfesor')"></label>
        <div class="tab-content web_tabs">
          <div class="">
            <div class="contenido_listado_estudios">
              <div class="row mx-0 titulo_academico_item" v-for="titulo in titulosAcademicosProfesorLista" :key="titulo.id">
                ...
                <div class="col-sm-auto row mx-0">
                  <div class="col-sm-auto opcion_titulo_academico d-flex align-items-center justify-content-center">
                    <a class="opcion_titulo_academico editar_titulo" type="button" @click="openPopupEditarNuevoTituloAcademico(titulo)">
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
              <button
                class="btn btn_agregar_estudio_profesor d-flex align-items-center justify-content-center"
                id="btn_agregar_estudio_profesor"
                v-text="$t('profesor.buttons.agregarEstudio')"
    ...
    <section>
      <b-modal id="modalPopupCrearEstudioProfesor" ref="modalPopupCrearEstudioProfesor">
              ...
              <div class="row mx-0">
                <div class="col form-group">
                  <label
                    class="form-control-label campo_requerido"
                    for="nombreTitulo"
                    v-text="$t('profesor.popups.labels.nombreTitulo')"
                  ></label>
                  <input
                    type="text"
                    id="nombreTitulo"
                    name="nombreTitulo"
                    class="form-control"
                    placeholder="Eg. Ingeniero..."
                    v-model="tituloAcademicoProfesor.nombreTitulo"
                    required
                  ...
                  <div v-if="$v.tituloAcademicoProfesor.nombreTitulo.$anyDirty && $v.tituloAcademicoProfesor.nombreTitulo.$invalid">
                    ...
                    <small
                      class="form-text text-danger"
                      v-if="!$v.tituloAcademicoProfesor.nombreTitulo.minLength"
                      v-text="$t('entity.validation.minlength', { min: 5 })"
                    >
                      This field cannot be longer than 50 characters.
                    </small>
                ...
                <div class="col form-group">
                  <label
                    class="form-control-label campo_requerido"
                    for="nombreUniversidadTitulo"
                    v-text="$t('profesor.popups.labels.nombreUniversidadTitulo')"
                  ></label>
                  <input
                    type="text"
                    id="nombreUniversidadTitulo"
                    name="nombreUniversidadTitulo"
                    class="form-control"
                    placeholder="Eg. Universidad..."
                    v-model="tituloAcademicoProfesor.nombreUniversidadTitulo"
                    @change="checkCamposFormularioTitulosAcademicos"
                    required
                  />
                  <div
                ...
                <div class="col-3 form-group">
                  <label
                    class="form-control-label campo_requerido"
                    for="yearTitulo"
                    v-text="$t('profesor.popups.labels.yearTitulo')"
                  ></label>
                  <input
                    type="date"
                    id="yearTitulo"
                    ...
                    min="1900-01-01"
                    :max="dateMax"
                    :value="convertDateTimeFromServer(tituloAcademicoProfesor.yearTitulo)"
                    @change="updateInstantFieldTituloAcademico('yearTitulo', $event)"
                    required
                  />
                  <div v-if="tituloAcademicoProfesor.yearTitulo === null || tituloAcademicoProfesor.yearTitulo === undefined">
                    <small class="form-text text-danger" v-text="$t('entity.validation.required')"> This field is required. </small>
                  </div>
                  <!--<div
              ...
              <div class="row mx-0">
                <div class="col-3 form-group">
                  <label
                    class="form-control-label campo_requerido"
                    for="tablaElementoCatalogo"
                    v-text="$t('profesor.popups.labels.tipoTitulo')"
                  ></label>
                  <select
                    class="form-control"
                    id="tablaElementoCatalogo"
                ...
                <div class="col-3 form-group">
                  <label class="form-control-label campo_requerido" for="paises" v-text="$t('profesor.popups.labels.paiseTitulo')"></label>
                  <select
                    class="form-control"
                    id="paises"
                    data-cy="paises"
                    ...
                    <option
                      v-bind:value="
                        tituloAcademicoProfesor.paises && paisesOption.id === tituloAcademicoProfesor.paises.id
                          ...
                          : paisesOption
                      "
                      v-for="paisesOption in listaPaises"
                      :key="paisesOption.id"
                    >
        ...
        <div slot="modal-footer">
          ...
          <button
            v-if="!isSaveTituloAcademico"
            type="button"
            class="btn btn_subir_documento"
            id="programaSubirDocumento"
            data-cy="entitySubirDocumentoButton"
            v-text="$t('entity.action.save')"

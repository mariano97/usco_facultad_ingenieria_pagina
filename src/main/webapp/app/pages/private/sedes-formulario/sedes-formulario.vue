          ...
          <div class="">
            <div class="row">
              <div class="col form-group">
                <label class="form-control-label campo_requerido" for="nombre_sede" v-text="$t('sede.formulario.labels.nombreSede')">
                  Nombre de la sede
                </label>
                <input
                  type="text"
              ...
              <div class="col-3 form-group">
                <label class="form-control-label campo_requerido" v-text="$t('sede.formulario.labels.codigoIndicativo')"></label>
                <input
                  type="text"
                  id="sede_codigo_indicativo"
                  name="sede_codigo_indicativo"
                  class="form-control"
            ...
            <div class="row">
              <div class="form-group col">
                <label class="form-control-label" for="sede_telefono_fijo" v-text="$t('sede.formulario.labels.telefonoFijo')"
                  >telefono fijo</label
                >
                <input
                  type="number"
                  class="form-control"
                  name="sede_telefono_fijo"
              ...
              <div class="form-group col">
                <label class="form-control-label" for="sede_telefono_celular" v-text="$t('sede.formulario.labels.telefonoCelular')"></label>
                <input
                  type="number"
                  class="form-control"
                  name="sede_telefono_celular"
            ...
            <div class="row">
              <div class="form-group col">
                <label class="form-control-label campo_requerido" v-text="$t('sede.formulario.labels.ciudad')">Ciudad</label>
                <select
                  class="form-control"
                  id="sedeCiudad"
                  data-cy="ciudad"
                  name="ciudad"
                  v-model="sede.ciudad"
                  v-on:change="changeSelectCiudad"
                  :disabled="checkHabilitacionCampos()"
                  required
                >
                  ...
                  <option
                    ...
                    v-for="ciudadOption in ciudadesLista"
                    :key="ciudadOption.id"
                  >
                    {{ ciudadOption.nombre }}
                  </option>
              ...
              <div class="form-group col">
                <label class="form-control-label campo_requerido" for="direccion_sede" v-text="$t('sede.formulario.labels.direccion')"
                  >Dirección</label
                >
                <input
                  type="text"
              ...
              <div class="form-group col">
                <label class="form-control-label campo_requerido" for="sede_latitud" v-text="$t('sede.formulario.labels.latitud')"
                  >Latitud</label
                >
                <input
                  type="number"
              ...
              <div class="form-group col">
                <label class="form-control-label campo_requerido" for="sede_longitud" v-text="$t('sede.formulario.labels.longitud')"
                  >Longitud</label
                >
                <input
                  type="number"

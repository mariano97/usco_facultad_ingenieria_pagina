          ...
          <div class="">
            <div class="row">
              <div class="col form-group">
                <label class="form-control-label" for="nombre_sede" v-text="$t('sede.formulario.labels.nombreSede')"> Nombre de la sede </label>
                <input
                  type="text"
                  id="nombre_sede"
                  name="nombre_sede"
            ...
            <div class="row">
              <div class="form-group col">
                <label class="form-control-label" for="direccion_sede" v-text="$t('sede.formulario.labels.direccion')">Dirección</label>
                <input
                  type="text"
                  id="direccion_sede"
                  name="direccion_sede"
              ...
              <div class="form-group col">
                <label class="form-control-label" for="sede_latitud" v-text="$t('sede.formulario.labels.latitud')">Latitud</label>
                <input
                  type="number"
                  class="form-control"
                  name="sede_latitud"
              ...
              <div class="form-group col">
                <label class="form-control-label" for="sede_longitud" v-text="$t('sede.formulario.labels.longitud')">Longitud</label>
                <input
                  type="number"
                  class="form-control"
                  name="sede_longitud"
            ...
            <div class="row">
              <div class="form-group col">
                <label class="form-control-label" for="sede_telefono_fijo" v-text="$t('sede.formulario.labels.telefonoFijo')">telefono fijo</label>
                <input
                  type="number"
                  class="form-control"

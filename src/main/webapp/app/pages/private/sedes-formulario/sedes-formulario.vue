<template>
  <div class="container_sedes_formulario">
          ...
          <div class="">
            <div class="row">
              <div class="col form-group">
                <label class="form-control-label campo_requerido" for="nombre_sede"
                  v-text="$t('sede.formulario.labels.nombreSede')">
                  Nombre de la sede
                </label>
                <input type="text" id="nombre_sede" name="nombre_sede" class="form-control "
                  placeholder="Eg. Sede Neiva" v-model="$v.sede.nombre.$model" :disabled="checkHabilitacionCampos()"
                  required />
              ...
              <div class="col-3 form-group">
                <label class="form-control-label campo_requerido"
                  v-text="$t('sede.formulario.labels.codigoIndicativo')"></label>
            ...
            <div class="row">
              ...
              <div class="form-group col">
                <label class="form-control-label campo_requerido" v-text="$t('sede.formulario.labels.email')"></label>
            ...
            <div class="row">
              <div class="form-group col">
                <label class="form-control-label campo_requerido"
                  v-text="$t('sede.formulario.labels.ciudad')">Ciudad</label>
                <select class="form-control " id="sedeCiudad" data-cy="ciudad" name="ciudad" v-model="sede.ciudad"
                  v-on:change="changeSelectCiudad" :disabled="checkHabilitacionCampos()" required>
                  <option v-if="!sede.ciudad" v-bind:value="null" selected>Seleccione</option>
                  <option v-bind:value="sede.ciudad && ciudadOption.id === sede.ciudad.id ? sede.ciudad : ciudadOption"
                    v-for="ciudadOption in ciudadesLista" :key="ciudadOption.id">
                    {{ ciudadOption.nombre }}
                  </option>
                </select>
                <div v-if="$v.sede.ciudad.$anyDirty && $v.sede.ciudad.$invalid">
                  <small class="form-text text-danger" v-if="!$v.sede.ciudad.required"
                    v-text="$t('entity.validation.required')">
                    This field is required.
                  </small>
                </div>
              ...
              <div class="form-group col">
                <label class="form-control-label campo_requerido" for="direccion_sede"
                ...
                <input type="text" id="direccion_sede" name="direccion_sede" class="form-control "
                  placeholder="Eg. Carrera 1H ..." v-model="$v.sede.direccion.$model" :disabled="true" required />
              ...
              <div class="form-group col">
                <label class="form-control-label campo_requerido" for="sede_latitud"
                ...
                <input type="number" class="form-control " name="sede_latitud" id="sede_latitud"
                  placeholder="Eg. -12.3444" v-model.number="$v.sede.latitud.$model" :disabled="true" required />
              ...
              <div class="form-group col">
                <label class="form-control-label campo_requerido" for="sede_longitud"
                ...
                <input type="number" class="form-control " name="sede_longitud" id="sede_longitud"
                  placeholder="Eg. 75.33333" v-model.number="$v.sede.longitud.$model" :disabled="true" required />
    ...
    <section class="map_continer mt-3">
      <div class="container_descripcion_uso_mapa mb-3">
        <p v-text="$t('sede.formulario.labels.usoMapa')"></p>
      </div>
      <l-map ref="map" style="height: 500px; width: 100%" @click="clickMap">
        <l-tile-layer :url="urlMap" :attribution="copyrightMap" />
        <l-marker v-if="showMapMarker" :lat-lng="markerLatLng"></l-marker>
      </l-map>
    </section>
  </div>
</template>

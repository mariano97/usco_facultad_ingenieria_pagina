  ...
  <div class="container_formulario_programa">
          ...
          <div class="">
            <div class="col form-group px-0">
              <label
                ...
                v-text="$t('programa.formulario.labels.nombrePrograma')"
                for="nombre_programa"
            ...
            <div class="row">
              <div class="form-group col-3">
                <label for="creditos" class="form-control-label campo_requerido" v-text="$t('programa.formulario.labels.creditos')"
                  >Creditos</label
                >
                <input
                  type="number"
              ...
              <div class="form-group col">
                <label
                  for="titulo_otorgado"
                  class="form-control-label campo_requerido"
                  v-text="$t('programa.formulario.labels.titloOtorgado')"
              ...
              <div class="form-group col-3">
                <label
                  for="costo_programa"
                  class="form-control-label campo_requerido"
                  v-text="$t('programa.formulario.labels.costoPrograma')"
                  >Titulo otrogado</label
                >
                <input
                  type="number"
            ...
            <div class="row">
              <div class="form-group col">
                <label
                  for="tipo_metodologia"
                  class="form-control-label campo_requerido"
                  v-text="$t('programa.formulario.labels.tipoMetodologia')"
              ...
              <div class="form-group col">
                <label
                  for="nivel_formacion"
                  class="form-control-label campo_requerido"
                  v-text="$t('programa.formulario.labels.nivelFormacion')"
                  ...
                  <div class="row">
                    <div class="form-group col">
                      <label
                        for="mision_programa"
                        class="form-control-label campo_requerido"
                        v-text="$t('programa.formulario.labels.misionPrograma')"
                    ...
                    <div class="form-group col">
                      <label
                        for="vision_programa"
                        class="form-control-label campo_requerido"
                        v-text="$t('programa.formulario.labels.visionPrograma')"
                        >Visión del programa</label
                      >
                      <div class="d-flex justify-content-end">
                        <small class="count_tamano_text" :class="{ count_text_limit: countCharacter(255, $v.programa.vision.$model) < 10 }"
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col">
                      <label
                        for="perfil_egresado"
                        class="form-control-label campo_requerido"
                        v-text="$t('programa.formulario.labels.pefilEgresado')"
                        >Visión del programa</label
                      >
                      <div class="d-flex justify-content-end">
                        <small
    ...
    <section class="seccion_documentos_programas" v-if="programa.id">
      <div class="tab">
        ...
        <label class="tab-label item_acordion" for="documentos_programa" v-text="$t('programa.formulario.labels.documentosProgramaTitle')"
          >Documentos del programa</label
        >
        <div class="tab-content web_tabs">
          <div class="">
            <div class="contenido_listado_archivos">
              <div class="row mx-0 archivo_item" v-for="archivo in filtrarArchivosProgramaOnlyDocs(archivosProgramaList)" :key="archivo.id">
                <div class="col container_name d-flex">
                  <h3>{{ archivo.nombreArchivo }}</h3>
                  <span
                    v-if="archivo.tablaElementoCatalogo.id === 7"
                    style="font-size: 18px; color: #8f141b"
                    class="pl-3"
                    v-text="$t('archivosPrograma.labels.planEstudio')"
                    >Plan de estudio</span
                  >
                </div>
                <div class="col-sm-auto row mx-0">
                  <div class="col-sm-auto opcion_archivo d-flex align-items-center justify-content-center">
                    <a id="opcion_archivo_ver_doc" class="opcion_archivo ver_doc" type="button" @click="verArchivoPrograma(archivo)">
                      <img alt="ver_documento" src="/content/images/iconos/search-red.png" />
                    </a>
                  </div>
                  <div class="col-sm-auto opcion_archivo d-flex align-items-center justify-content-center">
                    <a
                      id="opcion_archivo_cambiar_doc"
                      class="opcion_archivo cambiar_doc"
                      type="button"
                  ...
                  <div class="col-sm-auto opcion_archivo d-flex align-items-center justify-content-center">
                    <a
                      id="opcion_archivo_cambiar_doc"
                      class="opcion_archivo borrar_doc"
                      type="button"
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
              <button
                class="btn btn_agregar_documento d-flex align-items-center justify-content-center"
                id="btn_agregar_documento"
                v-text="$t('programa.buttons.agregarDocumento')"
    ...
    <section class="seccion_redes_programas">
      <div class="tab">
        ...
        <label class="tab-label item_acordion" for="redes_programa" v-text="$t('programa.formulario.labels.redesPrograma')"
          >Redes Programa</label
        >
        <div class="tab-content web_tabs">
          <div class="">
              ...
              <div class="row mx-0 archivo_item" v-for="redSocial in redesSocialesPrograma" :key="redSocial.id">
                <div class="col container_name row">
                  <div class="col-sm-auto container_imagen_red_social d-flex align-items-center">
                    <img
                      v-if="redSocial.tablaElementoCatalogo.id === 8"
                      alt="red_social-facebook"
                      src="/content/images/iconos/facebook.png"
                    />
                    <img
                      v-if="redSocial.tablaElementoCatalogo.id === 9"
                      alt="red_social-instagram"
                      src="/content/images/iconos/instagram.png"
                    />
                    <img
                      v-if="redSocial.tablaElementoCatalogo.id === 10"
                      alt="red_social-tiktok"
                      src="/content/images/iconos/tik-tok.png"
                    />
                    <img
                      v-if="redSocial.tablaElementoCatalogo.id === 11"
                      alt="red_social-twitter"
                      src="/content/images/iconos/twitter.png"
                    />
                    <img
                      v-if="redSocial.tablaElementoCatalogo.id === 12"
                      alt="red_social-you-tube"
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
              <button
                class="btn btn_agregar_red_social d-flex align-items-center justify-content-center"
                id="btn_agregar_red_social"
                v-text="$t('programa.buttons.agregarRedSocial')"
    ...
    <section>
      <b-modal id="modalPopupCrearDocumentoPrograma" ref="modalPopupCrearDocumentoPrograma" class="modalPopupCrearDocumentoPrograma">
        <div class="modal-body">
          <div class="">
            <div class="mb-3 container_notas">
              <span v-if="!hasArchivoProgramaPlanEstudio" v-text="$t('archivosPrograma.labels.favorSubirPlanEstudio')"
                >Por favor subir el plan de estudio</span
              >
            </div>
            <a id="" type="button" class="btn btn-upload d-flex align-items-center justify-content-center">
              ...
              <input id="file-crear-documento-nuevo" type="file" accept="application/pdf" @change="changeAgregarDocumentoNuevo" />
            </a>
        ...
        <div slot="modal-footer">
          ...
          <button
            v-if="programaDocumentoNuevo.isValidDoc && !isArchivoDocumentoNuevoUploaded"
            type="button"
            class="btn btn_subir_documento"
            id="programaSubirDocumento"
            data-cy="entitySubirDocumentoButton"
            v-text="$t('entity.action.subir')"
      ...
      <b-modal id="modalPopupEliminarDocumentoPrograma" ref="modalPopupEliminarDocumentoPrograma">
        ...
        <div slot="modal-footer">
          ...
          <button
            v-if="!isArchivoDocumentoNuevoUploaded"
            type="button"
            class="btn btn_subir_documento"
            id="programaEliminarDocumento"
            data-cy="entityEliminarDocumentoButton"
            v-text="$t('entity.action.delete')"
      ...
      <b-modal id="modalPopupAgregarRedSocial" ref="modalPopupAgregarRedSocial">
          ...
          <form name="formRedSocial" role="form">
            <div class="row mx-0">
              <div class="col form-group">
                <label class="form-control-label" v-text="$t('programa.popups.labels.tipoResSocial')" for="tipo_red_social"
                ...
                >
                  ...
                  <option
                    v-for="tipoRedSocial in tiposRedSocialElemento"
                    :key="tipoRedSocial.id"
                    v-bind:value="
              ...
              <div class="col form-group">
                <label
                  class="form-control-label campo_requerido"
                  for="url_red_social_programa"
                  v-text="$t('programa.popups.labels.urlRedSocial')"
                  >Url de la red social</label
                >
                <input
                  type="text"
                  id="url_red_social_programa"
                  name="url_red_social_programa"
                  class="form-control"
                  placeholder="Eg. redSocial.com/pagina"
                ...
                <div v-if="$v.redesPrograma.urlRedSocial.$anyDirty && $v.redesPrograma.urlRedSocial.$invalid">
                  <small
                    class="form-text text-danger"
                    v-if="!$v.redesPrograma.urlRedSocial.required"
                    v-text="$t('entity.validation.required')"
                  >
                    This field is required.
                  </small>
        ...
        <div slot="modal-footer">
          ...
          <button
            v-if="!isRedSocialCreatedUptaded"
            type="button"
            class="btn btn_subir_documento"
            id="programaRedSocialAgregarActualizar"
            v-text="$t('entity.action.save')"
            v-on:click="agregarActualizarRedSocial()"
            :disabled="$v.redesPrograma.$invalid"
          >
            Agregar / Actualizar
          </button>
          <button

...
export default class JhiUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-paginafacultadingenieriaproyectoapp-alert'], {
          param: decodeURIComponent(res.headers['x-paginafacultadingenieriaproyectoapp-params'].replace(/\+/g, ' ')),
        });

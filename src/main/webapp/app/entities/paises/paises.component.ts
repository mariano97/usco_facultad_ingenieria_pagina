...
export default class Paises extends mixins(JhiDataUtils) {
  ...
  public retrieveAllPaisess(): void {
  ...
  public prepareRemove(instance: IPaises): void {
  ...
  public removePaises(): void {
    this.paisesService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('paginaFacultadIngenieriaProyectoApp.paises.deleted', { param: this.removeId });

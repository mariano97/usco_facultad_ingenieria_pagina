...
export default class TablaTiposCatalogo extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllTablaTiposCatalogos();
  }
  ...
  public retrieveAllTablaTiposCatalogos(): void {
  ...
  public prepareRemove(instance: ITablaTiposCatalogo): void {
  ...
  public removeTablaTiposCatalogo(): void {
    this.tablaTiposCatalogoService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('paginaFacultadIngenieriaProyectoApp.tablaTiposCatalogo.deleted', { param: this.removeId });

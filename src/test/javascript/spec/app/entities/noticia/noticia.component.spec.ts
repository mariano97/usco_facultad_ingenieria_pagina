...
import NoticiaComponent from '@/entities/noticia/noticia.vue';
import NoticiaClass from '@/entities/noticia/noticia.component';
...
describe('Component Tests', () => {
  describe('Noticia Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<NoticiaClass>(NoticiaComponent, {
        store,
        i18n,
        localVue,
    ...
    it('Should call load all on init', async () => {
      ...
      // WHEN
      comp.retrieveAllNoticias();
      await comp.$nextTick();

      // THEN
      expect(noticiaServiceStub.retrieve.called).toBeTruthy();
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(noticiaServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(noticiaServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(noticiaServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});

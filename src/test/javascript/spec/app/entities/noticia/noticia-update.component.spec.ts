...
import NoticiaUpdateComponent from '@/entities/noticia/noticia-update.vue';
import NoticiaClass from '@/entities/noticia/noticia-update.component';
...
describe('Component Tests', () => {
  describe('Noticia Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<NoticiaClass>(NoticiaUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.noticia = entity;
        noticiaServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(noticiaServiceStub.update.calledWith(entity)).toBeTruthy();
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        noticiaServiceStub.retrieve.resolves([foundNoticia]);
